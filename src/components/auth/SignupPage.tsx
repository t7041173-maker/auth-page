    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-paypal-gray">Create your account</p>
        </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-start space-x-2">
              <Checkbox
                ...
                className="mt-1"
              />
              <Label htmlFor="terms" className="text-sm text-paypal-gray leading-5">
                I agree to PayPal's{" "}
                <a href="#" className="text-paypal-blue hover:text-paypal-blue-hover">
                  User Agreement
                </a>{" "}
                and{" "}
                <a href="#" className="text-paypal-blue hover:text-paypal-blue-hover">
            ...
            <div className="relative">
              ...
              <span className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-background px-4 text-sm text-paypal-gray">
                or
              </span>
            </div>
            ...
            <div className="space-y-3">
              <Button 
                variant="outline" 
                className="w-full h-12 border-border hover:bg-paypal-gray-light font-medium"
                type="button"
              >
